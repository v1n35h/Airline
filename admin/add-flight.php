                            ...
                            <div class="widget-content widget-content-area">
                                <form method="POST" action="<?php echo url('flight.php')?>" enctype="multipart/form-data">
                                    <div class="form-group mb-4">
                                        ...
                                        <input id="name" class="form-control" placeholder="Enter Flight Name" name="name" required>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="icon">Icon</label>
                                        <input type="file" id="icon" class="form-control" name="icon" required accept="image/*">
                                    </div>
