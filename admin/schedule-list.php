                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="default-ordering" class="table table-hover style-2" style="width:100%">
                                    ...
                                    <?php
                                        ...
                                        $sql = "select schedules.*,from_city.name as from_city,to_city.name as to_city,flights.name as flight_name from schedules JOIN cities as from_city ON schedules.from_city_id=from_city.id JOIN cities as to_city ON schedules.to_city_id=to_city.id JOIN flights on schedules.flight=flights.id";
