                                    ...
                                    <?php
                                        ...
                                        if ($result = $conn->query($sql)) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>" . $row['name'] . "</td>";
                                                echo "<td>";
                                                echo '<a href="'.url("edit-city.php?city_id=$city_id") .'"><button class="btn btn-success">Edit</button></a>';
                                                echo '<a href="'.url("city.php?submit=delete&city_id=$city_id") .'" onclick="return confirm(\'Are You Sure ?\')"><button class="btn btn-danger">Delete</button></a>';
                                                echo "</td></tr>\n";
                                                $i++;
                                            }
                                        }
