                                    ...
                                    <?php
                                        ...
                                        if ($result = $conn->query($sql)) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<tr><td>" . $i . "</td>";
                                                echo "<td>" . $row['name'] . "</td>";
                                                echo "<td><img height=50px width=50px src='" . $row['icon'] . "'></td>";
                                                echo "<td>";
                                                echo '<a href="'.url("edit-flight.php?flight_id=$flight_id") .'"><button class="btn btn-success">Edit</button></a>';
                                                echo '<a href="'.url("flight.php?submit=delete&flight_id=$flight_id") .'" onclick="return confirm(\'Are You Sure ?\')"><button class="btn btn-danger">Delete</button></a>';
                                                echo "</td></tr>\n";
                                                $i++;
                                            }
                                        }
